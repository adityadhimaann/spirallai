...
const SUB_STATUSES: Record<NodeKey, string[]> = {
  ...
  competitive: [
    ...
    "Extracting peer multiples...",
    "Synthesizing landscape...",
  ],
  bull: [
    "Drafting optimistic thesis...",
    "Highlighting growth catalysts...",
    "Formatting bull case...",
    "Finalizing bull perspective...",
  ],
  bear: [
    "Drafting skeptical thesis...",
    "Highlighting key risks...",
    "Formatting bear case...",
    "Finalizing bear perspective...",
  ],
  judge: [
            ...
            {uniqueDomains.length > 0 && (
              <div className="mt-3 flex flex-wrap gap-2 animate-in fade-in slide-in-from-top-1">
                {uniqueDomains.map((domain, idx) => (
                  <div
                    key={idx}
                    className="flex items-center gap-2 rounded-full border border-white/10 bg-black/20 backdrop-blur-md px-3 py-1.5 shadow-sm hover:border-primary/40 transition-colors"
                  >
                    <img
