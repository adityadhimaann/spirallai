...
export async function fetchFinancials(companyName, ticker) {
  ...
  try {
    ...
    return {
      ...
      enterpriseValue: metricData.enterpriseValue ? (metricData.enterpriseValue * 1000000) : "Not disclosed.",
      revenueTTM: (metricData.revenuePerShareTTM && profile.shareOutstanding) ? (metricData.revenuePerShareTTM * profile.shareOutstanding * 1000000) : "Not disclosed.",
      grossProfitTTM: (metricData.grossMarginTTM && metricData.revenuePerShareTTM && profile.shareOutstanding) ? (metricData.grossMarginTTM / 100 * metricData.revenuePerShareTTM * profile.shareOutstanding * 1000000) : "Not disclosed.",
      ebitda: (metricData.ebitdPerShareTTM && profile.shareOutstanding) ? (metricData.ebitdPerShareTTM * profile.shareOutstanding * 1000000) : "Not disclosed.",
      peRatio: metricData.peExclExtraTTM || metricData.peExclExtraAnnual || "Not disclosed.",
      forwardPE: metricData.forwardPE || "Not disclosed.",
      pegRatio: metricData.pegTTM || metricData.forwardPEG || "Not disclosed.",
